...
- A StoreBroker-ready docs/store-submission/ bundle (per-language ProductDescription PDP files + screenshots) generated by scripts/build-store-submission.ps1, for API-driven listing submission.
